...
import static seedu.clinic.logic.commands.CommandTestUtil.TAG_DESC_FRIEND;
import static seedu.clinic.logic.commands.CommandTestUtil.TAG_DESC_HUSBAND;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(BOB).withId(0)
        ...
        Person expectedPersonMultipleTags = new PersonBuilder(BOB).withId(0)
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Person expectedPerson = new PersonBuilder(AMY).withId(0).withTags().build();
