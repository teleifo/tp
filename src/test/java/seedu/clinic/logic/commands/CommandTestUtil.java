...
public class CommandTestUtil {
    ...
    public static final int VALID_ID_AMY = 1;
    public static final int VALID_ID_BOB = 2;
    ...
    public static final String INVALID_NAME_DESC = " " + PREFIX_NAME + " "; // blank name not allowed
     ...
     * - clinic book, filtered person list and selected person in {@code actualModel} remain unchanged
     */
