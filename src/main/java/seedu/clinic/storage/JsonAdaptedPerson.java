...
class JsonAdaptedPerson {
     ...
     */
    public JsonAdaptedPerson(int id, String name, String phone, String email) {
        this(id, name, phone, email, "N/A");
    }
    ...
    public Person toModelType() throws IllegalValueException {
        ...
        return new Person(modelName, modelPhone, modelEmail, modelAddress, modelId);
    }
