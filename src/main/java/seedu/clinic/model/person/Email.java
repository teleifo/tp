...
/**
 * Represents a Person's email in clinic book.
...
public class Email {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Emails should be of the format local-part@domain "
            ...
            + "    - contain at least one period, i.e. a top-level domain is required (e.g. .com, .sg)\n"
    ...
    private static final String LOCAL_PART_REGEX = "^" + ALPHANUMERIC_NO_UNDERSCORE
            + "(?:(?:" + ALPHANUMERIC_NO_UNDERSCORE + "|" + SPECIAL_CHARACTERS_REGEX + ")*"
